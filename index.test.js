...
test('tryToMerge_with_missing_develop_should_be_skipped', async () => {
  ...
  const branches = Promise.resolve(["feature/ABC-123", "release/1.0.0", "release/2.0.0"])
...
test('tryToMerge_with_available_target_branch_should_be_successfully', async () => {
  ...
  const branches = Promise.resolve(["feature/ABC-123", "release/1.0.0", "release/2.0.0", "origin/develop"])
...
describe('getTargetBranch_should_match_expected_branch', () => {
  test.each([
    [["origin/develop", "origin/feature/ABC-0001", "origin/release/1.0.0", "origin/release/2.0.0"], "release/1.0.0", "release/2.0.0"],
    [["origin/develop", "origin/feature/ABC-0001", "origin/release/1.0.0", "origin/release/1.0.1", "origin/release/2.0.0"], "release/1.0.0", "release/1.0.1"],
    [["origin/develop", "origin/feature/ABC-0001", "origin/release/1.0.0", "origin/release/1.1.0", "origin/release/2.0.0"], "release/1.0.0", "release/1.1.0"],
    [["origin/develop", "origin/feature/ABC-0001", "origin/release/1.0.0"], "release/1.0.0", "develop"]
